...
> **Note**: si l'importation du roman avec la fonction `gutenberg_download(…)` pose problème, remplacez la première ligne d'instruction du bloc par l'instruction suivante:
>
